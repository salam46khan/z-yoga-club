        ...
        <div id='about'>
            <div className="container flex flex-col md:flex-row justify-between items-center py-10 md:py-20 ">
                <div className='w-full md:w-1/2 p-3 md:p-6'>
                    <p className='font-extrabold tracking-wide mySub letter-spacing'>ABOUT US</p>
                    <h4 className='myTitle text-2xl md:text-4xl py-2 font-extrabold'>Your Sanctuary for <span className='text-primaryColor'>
